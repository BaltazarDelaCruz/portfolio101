...
<nav class="navbar navbar-expand-lg fixed-top">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="home.php?portfolio=<?= htmlspecialchars($portfolio['public_id']) ?>">Home</a>
            </li>
            <li class="nav-item">
  ...
  <section  class="home container">
        <div class="text-center">
            <div class="d-flex align-items-center justify-content-center text-center">
                ...
                <div>
                    <h1>I'm <?= isset($portfolio['name']) ? htmlspecialchars($portfolio['name']) :'Your name'?>!</h1>
  ...
  <script>
    ...
    if (savedMode === 'dark') {
        ...
        document.querySelectorAll('.home').forEach(home => home.classList.add('dark-mode'));
        ...
        document.querySelectorAll('.btn').forEach(p => p.classList.add('dark-mode'));
    }
});

document.getElementById('nightModeToggle').addEventListener('click', function () {
    document.body.classList.toggle('dark-mode');
    document.querySelectorAll('nav').forEach(nav => nav.classList.toggle('dark-mode'));
    document.querySelectorAll('.nav-link').forEach(link => link.classList.toggle('dark-mode'));
    document.querySelectorAll('.home').forEach(home => home.classList.toggle('dark-mode'));
...
function toggleNightMode() {
        ...
        const nightModeText = document.querySelector('#nightModeToggle span');
        nightModeText.textContent = document.body.classList.contains('night-mode') 
            ? 'Dark Mode' 
            : 'Light Mode';
